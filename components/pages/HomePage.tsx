    ...
    <>
      ...
      <section className="bg-ink">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 px-6 py-20 text-center sm:py-28">
          ...
          <Image src="/brand/logo.png" alt="Ader Games" width={880} height={880} priority className="h-auto w-[min(420px,72vw)] object-cover" />
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid overflow-hidden rounded-2xl border border-parchdeep bg-parchment shadow-[0_3px_0_#E4D3AC] sm:grid-cols-[280px_1fr]">
          <Image src="/fisuevolution/icon.png" alt="" width={560} height={560} className="h-full w-full object-cover" />
